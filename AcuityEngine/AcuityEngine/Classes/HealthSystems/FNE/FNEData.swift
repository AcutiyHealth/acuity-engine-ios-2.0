...
class FNEData {
    ...
    func dictionaryRepresentation()->[String:Any]{
        ...
        return [MetricsType.Conditions.rawValue:fneCondition.dictionaryRepresentation(),MetricsType.Sympotms.rawValue:fneSymptoms.dictionaryRepresentation()] as [String : Any]
