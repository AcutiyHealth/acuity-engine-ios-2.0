...
class CardioData:SystemDataProtocol {
    ...
    func dictionaryRepresentation()->[String:Any]{
        return [MetricsType.Conditions.rawValue:cardioCondition.dictionaryRepresentation(),MetricsType.Sympotms.rawValue:cardioSymptoms.dictionaryRepresentation()] as [String : Any]
