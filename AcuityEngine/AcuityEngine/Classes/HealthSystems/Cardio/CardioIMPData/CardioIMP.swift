...
class CardioIMP:VitalProtocol {
    ...
    func getArrayDataForVitals(days:SegmentValueForGraph,title:String) -> [VitalsModel]{
        ...
        var filterArray:[IMPCalculation] = []
...
func filterArrayWithSelectedSegmentInGraph(days:SegmentValueForGraph,array:[IMPCalculation])->[IMPCalculation]{
    ...
    var filteredArray:[IMPCalculation] = []
