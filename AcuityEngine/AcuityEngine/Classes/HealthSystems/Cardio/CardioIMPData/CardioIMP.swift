...
class CardioIMP {
    ...
    var heartRateData:CardioIMPData?
    var systolicBloodPressureData:CardioIMPData?
    var diastolicBloodPressureData:CardioIMPData?
    var irregularRhythmNotificationData:CardioIMPData?
    var highHeartRateData:CardioIMPData?
    var lowHeartRateData:CardioIMPData?
    var vO2MaxData:CardioIMPData?
